...
vector<Vehicle> Vehicle::choose_next_state(map<int, vector<Vehicle>> &predictions) {
   ...
   */
    float cost;
    vector<float> costs;
    vector<string> succ_states = successor_states();
    vector<vector<Vehicle>> final_trajectories;
    for (vector<string>::const_iterator iter = succ_states.begin(); iter != succ_states.end(); ++iter)
    {
        std::map<int, std::vector<Vehicle> > predictions;
        vector<Vehicle> trajectory_for_state = generate_trajectory(*iter, predictions);
